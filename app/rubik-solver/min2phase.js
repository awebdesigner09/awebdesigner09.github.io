...
var min2phase = (function() {
	...
	return {
		Search: Search,
		solve: function(facelet, maxDepth, probeMax, probeMin) {
			return new Search().solution(facelet, maxDepth, probeMax, probeMin);
		},
		...
		CubieCube: CubieCube,          // Expose the constructor
        moveCube: moveCube,          // Expose the moveCube array
        move2str: move2str,          // Expose move notation mapping
        CubieCube_CornMult: CubieCube.CornMult, // Expose static method
        CubieCube_EdgeMult: CubieCube.EdgeMult  // Expose static method
	}
})();
